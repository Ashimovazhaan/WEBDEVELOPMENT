...
import {consoles, Console} from '../consoles';
import {Product} from '../products';

@Component({
  selector: 'app-playconsole-list',
  templateUrl: './playconsole-list.component.html',
  styleUrls: ['./playconsole-list.component.css']
})
export class PlayconsoleListComponent implements OnInit {

  consoles = consoles;


  share(product: Console): void {
